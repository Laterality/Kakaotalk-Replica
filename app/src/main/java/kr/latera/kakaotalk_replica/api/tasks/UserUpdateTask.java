...
public class UserUpdateTask extends AsyncTask<String, Void, UserResponseDto>
{
	private static String TAG;
	private AsyncCallback<UserResponseDto> cb;

	public UserUpdateTask(AsyncCallback<UserResponseDto> callback)
	{
	...
	protected UserResponseDto doInBackground(String... params)
	{
		try
		{
			...
			Call<UserResponseDto> call = service.updateUser(new UserUpdateRequestDto(
					params[0],
					params[1],
					params[2]
			));
