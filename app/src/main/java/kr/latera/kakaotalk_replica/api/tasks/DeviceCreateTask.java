...
public class DeviceCreateTask extends AsyncTask<String, Void, DeviceResponseDto>
{
	private AsyncCallback<DeviceResponseDto> cb;
	private static String TAG;

	public DeviceCreateTask(AsyncCallback<DeviceResponseDto> callback)
	{
	...
	@Override
	public DeviceResponseDto doInBackground(String... params)
	{
		try
		{
			...
			Call<DeviceResponseDto> call = service.createDevice(new DeviceRequestDto(
					params[0],
					params[1],
					params[2],
					params[3]
